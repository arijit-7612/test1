...
def draw_checkbox(x, y, checked=False):
    ...
    if checked:
        pygame.draw.line(screen, WHITE, (x, y), (x + CHECKBOX_SIZE, y + CHECKBOX_SIZE), 3)
        pygame.draw.line(screen, WHITE, (x + CHECKBOX_SIZE, y), (x, y + CHECKBOX_SIZE), 3)

def quiz_screen(question, selected_idx=None):
    screen.blit(background, (0, 0))
    ...
    for idx, option in enumerate(question["options"]):
        draw_checkbox(50, 150 + idx * 50, checked=(selected_idx == idx and option == question["answer"]))
            ...
            if event.type == pygame.QUIT:
                ...
                if in_start_screen:
                    ...
                    for idx, option in enumerate(questions[current_question]["options"]):
                        option_rect = pygame.Rect(50, 150 + idx * 50, SCREEN_WIDTH - 150, 50)
                        if option_rect.collidepoint(mouse_pos):
                            ...
                            if option == questions[current_question]["answer"]:
                                ...
                                wrong_answer_screen()
                                quiz_screen(questions[current_question], selected_idx)
