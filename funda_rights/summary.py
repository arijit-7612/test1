...
TOP_MARGIN = 69  # Additional margin at the top
BOTTOM_MARGIN = 30  # Additional margin at the bottom, above the close button
CLOSE_BUTTON_HEIGHT = 30 # Height of the close button
...
This means the process must be clearly defined by law and adhere to the principles of natural justice.
    ...
    while True:
        ...
        max_text_height = POPUP_HEIGHT - close_button_y - CLOSE_BUTTON_HEIGHT - BOTTOM_MARGIN
        ...
        max_scroll = max(0, text_bottom - max_text_height)
