...
subscription_key = "6e42b5ece252438c89ae74eb71162319"
...
font1 = pygame.font.Font("times_new.ttf", 15)
...
while running:
        ...
        for button in language_buttons:
            if button.is_clicked(event):
                ...
                if new_language != current_language:
                    ...
                    dialogue_lines = render_dialogue(translated_dialogues[current_dialogue_index])
    ...
    if current_dialogue_index == 18:
        ...
        screen.blit(frames1[current_frame], (sprite_x+25 , sprite_y - 153))
        clock.tick(20)
        if current_time - audio_start_time >= 1000 and new_audio_ready:
            pygame.mixer.music.load("hammer.mp3")
            pygame.mixer.music.play(-1)
            pygame.time.wait(500)
            pygame.mixer.music.stop()
